...
- [ ] **Sprint 5 — v1.0.0 릴리스 + Public 전환**: API 동결 결정, repo Private→Public, `udit update` 401 해소 검증, Unity Connector git URL 익명 clone 검증, B3 (console --json data 구조 일관화) 결정, beta→stable badge 조정
