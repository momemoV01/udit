...
// Instance represents a running Unity Editor discovered from ~/.udit/instances/.
...
func instancesDir() string {
	...
	return filepath.Join(home, ".udit", "instances")
}

// ScanInstances reads all instance files from ~/.udit/instances/.
...
// DiscoverInstance finds a running Unity instance from ~/.udit/instances/.
