...
{
    [UditTool(Name = "exec", Description = "Execute arbitrary C# code at runtime. Full access to Unity and all loaded assemblies.")]
    public static class ExecuteCsharp
    {
        ...
        private static object CompileAndExecute(string source, string cscOverride = null, string dotnetOverride = null)
        {
            ...
            var tmpDir = Path.Combine(Path.GetTempPath(), "udit-exec");
